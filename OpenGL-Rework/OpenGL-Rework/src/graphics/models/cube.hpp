...
public:
	...
	void init() {
		...
		Texture flag("assets/image3.jpg", "material.diffuse");
		flag.load();

		Texture flagSpec("assets/image3_specular.jpg", "material.specular");
		flagSpec.load();

		mesh = Mesh(Vertex::genList(vertices, noVertices), indices, { flag,flagSpec });
	}
