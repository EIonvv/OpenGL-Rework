...
bool Keyboard::key(int key) { return keys[key]; }
...
bool Keyboard::keyWentDown(int key) { return keys[key] && keyChanged(key); }

bool Keyboard::keyWentUp(int key) { return !keys[key] && keyChanged(key); }